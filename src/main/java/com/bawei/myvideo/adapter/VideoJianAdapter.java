...
public class VideoJianAdapter extends RecyclerView.Adapter<VideoJianAdapter.Myviewholder> {
     private List<Xiangqingbean.RetBean.ListBean.ChildListBean> list;
     private Context context;

    public VideoJianAdapter(List<Xiangqingbean.RetBean.ListBean.ChildListBean> list, Context context) {
        this.list = list;
