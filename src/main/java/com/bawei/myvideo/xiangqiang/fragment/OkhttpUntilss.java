...
public class OkhttpUntilss {
    private volatile static OkhttpUntilss util=null;
    private OkhttpUntilss(){
    }
    public static OkhttpUntilss getmInstance(){
        if (util==null){
            synchronized (OkhttpUntilss.class){
                if (util==null){
                    util=new OkhttpUntilss();
                }
            }
        }
        return util;
